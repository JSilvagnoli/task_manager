...
def handle_update_task(task_list):
...
COMMANDS = {
	...
	"5": handle_search_tasks_by_name,
	"6": handle_stats,
	"7": handle_sort,
	"8": handle_save,
	"9": handle_load,
	"10": handle_close_program
}
